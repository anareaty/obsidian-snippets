...
if (category == "Книги") {
 ...
 props = [
 {prop: "cover", type: "text", header: "Обложка", imageWidth: 60},
 {prop: "link", type: "file prop", header: "Название"},
 {prop: "Автор", type: "list", buttonName: "#Автор", header: "Автор", span: true},
 {prop: "Жанр", type: "list", multiSelect: true, buttonName: "#Жанр", header: "Жанр", span: true},
 {prop: "Цикл", type: "text", buttonName: "#Цикл", header: "Цикл"},
 {prop: "Статус чтения", type: "list", buttonName: "#Статус", header: "Статус", span: true},
...
if (type == "scene") {
newNote.templatePath = "_/templates/notes/writing/Сцена"
...
if (type == "note") {
newNote.templatePath = "_/templates/notes/writing/Заметка к тексту"
}
...
newNote.templatePath = "_/templates/notes/writing/Стихотворение"
...
if (type == "story board") {
newNote.templatePath = "_/templates/notes/writing/Ориджинал"
}
