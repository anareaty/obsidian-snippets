...
- вы можете фильтровать таблицы по свойствам с помощью кнопок фильтрации;
- вы можете использовать пагинацию, чтобы разнести записи на отдельные страницы;
- вы можете легко переключаться между представлениями таблиц, карточек и списков;
- вы можете редактировать свойства прямо из таблицы, не открывая заметку;
- вы можете отображать свойства как изображения, функциональные чекбоксы и ползунки;
- вы можете использовать разные цвета для разных значений свойств;
- вы можете обновлять представление с помощью специальной кнопки;
- вы можете добавить кнопку для создания новой заметки;
- вы можете делать все это с минимальным редактированием кода.
